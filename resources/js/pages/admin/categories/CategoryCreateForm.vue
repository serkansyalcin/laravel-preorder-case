<template>
    ...
    <ConfirmationBox v-if="isModalVisible" title="Create category"
        :message="`Are you sure you want to insert this category?`" :isVisible="isModalVisible" @confirm="submitForm"
        @cancel="closeModal" />
</template>
